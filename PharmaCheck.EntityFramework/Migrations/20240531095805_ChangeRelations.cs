    ...
    public partial class ChangeRelations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Pharmacy Products", x => new { x.PharmacyId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_Pharmacy Products_Pharmacies_PharmacyId",
                        column: x => x.PharmacyId,
                        principalTable: "Pharmacies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Pharmacy Products_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pharmacy Products_ProductId",
